...
Feature: SquadVentasDigitales_GoldTarjetas
    ...
    # @Happypath @SquadVentasDigitalesGoldTarjetas
    # Scenario: I want to cancel the Deeplink Gold credit card flow
 
    #     Given In order to enter the Deeplink Gold Credit card flow screen, first click on the Tarjeta Gold link
    #        And the user tap the button Acceder in Prelogin screen
    #     And user login with password "321321"
    #     When Select Ver Mas Detalle Button of deeplink gold credit card
    #     And Press option Cancelar or Ir a mis productos when MCR flag is true or fail to go to dashboard and cancel flow



    @Happypath @SquadVentasDigitalesGoldTarjetas@SquadVentasDigitales
    Scenario: I want to check deep link Gold credit card flow for office branch
      Given In order to enter the Deeplink Gold Credit card flow screen, first click on the Tarjeta Gold link
        And the user tap the button Acceder in Prelogin screen
        And user login with password "321321"
        When Select Solicitar tarjeta Button Button of deeplink gold credit card
    #     And On the card selection screen, select one of the gold cards displayed on the screen
    ...
    # # @Happypath @SquadVentasDigitalesGoldTarjetas
    #  Scenario: I want to check deep link Gold credit card flow for Delivery Form
    #     Given In order to enter the Deeplink Gold Credit card flow screen, first click on the Tarjeta Gold link
    #     And the user tap the button Acceder in Prelogin screen
    #     And user login with password "321321"
    #     When Select Solicitar tarjeta Button Button of deeplink gold credit card
